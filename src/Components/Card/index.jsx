...
const Card = (data) => {
    ...
    const renderIcon = (id) => {
        ...
        <div 
          ...
          <CheckIcon className='h6 w-6 text-white'></CheckIcon>
        </div>
            )
        } else {
            return (
        <div 
          ...
          <PlusIcon className='h6 w-6 text-black'></PlusIcon>
        </div>
            )
        }
    }
  ...
  return (
    ...
    onClick={() => showProduct(data.data)}>
        ...
        <p className="flex justify-between">
            <span className="truncate text-sm font-light">{data.data.title}</span>
